...
const SecondCardScript = (props) => {
    ...
    return (
        <Box sx={{ width: '200px', height: '400px', display: 'flex', justifyContent: 'space-between', flexDirection: 'column', borderRadius: '10px', marginTop: '10px', gap: '1rem', padding: '10px', color: blueColor, backgroundColor: 'white', boxShadow: '2px 2px 2px rgba(0,0,0,0.3)' }}>
            <Box sx={imageBanner} />
...
export default SecondCardScript;